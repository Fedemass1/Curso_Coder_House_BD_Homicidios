...
El tercer y último se llama p_relacion (relación de la víctima con el victimario) y puede ser de la siguiente forma:
...
Lo que se logra con su utilziación es obviar la utilización de cierto/s parámetros como filtros. Por ejemplo, si solo se quisiera saber la cantidad
